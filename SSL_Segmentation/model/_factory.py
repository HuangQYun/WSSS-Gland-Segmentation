...
def load_model_config_from_hf(model_id: str, json_path: str):
    hf_config = load_cfg_from_json(json_path)
...
def create_model(
    ...
    if model_source == 'hf-hub':
        ...
        pretrained_cfg, model_name, model_args = load_model_config_from_hf(model_name, json_path)
        if model_args:
